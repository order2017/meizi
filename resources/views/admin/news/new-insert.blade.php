...
@section('content')
    ...
    <div class="admin-content-body">
        <div class="am-cf am-padding am-padding-bottom-0">
            <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">新闻添加</strong> / <small>New Insert</small></div>
        </div>
        ...
        <div class="am-g">
            ...
            <div class="am-u-sm-12 am-u-md-8 am-u-md-pull-4">
                ...
                <form class="am-form am-form-horizontal" method="post" action="{{ url('/admin/new-insert') }}" enctype="multipart/form-data" data-am-validator>
                    {{ csrf_field() }}
                    <fieldset>
                        <div class="am-form-group">
                            <label for="new_title" class="am-u-sm-3 am-form-label">标题：</label>
                            <div class="am-u-sm-9">
                                <input type="text" id="new_title" name="new_title" placeholder="请输入标题" required>
                            </div>
                        </div>
                        ...
                        <div class="am-form-group">
                            ...
                            <div class="am-u-sm-9">
                                <div class="am-form-group am-form-file">
                                    <img id="new_picture" src="/uploads/{{ app('common')->upload->logo }}" class="am-img-thumbnail" style="height: 160px">
                        ...
                        <div class="am-form-group">
                            ...
                            <div class="am-u-sm-9">
                            {{--<textarea name="new_content" rows="10" id="new_content" placeholder="输入内容"></textarea>--}}
                            <!-- 编辑器容器 -->
                        ...
                        <div class="am-form-group">
                            ...
                            <div class="am-u-sm-9">
                                <input type="number" id="new_order" name="new_order" value="0" placeholder="请输入排序" required>
                            </div>
                        </div>
